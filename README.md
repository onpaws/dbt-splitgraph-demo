...
Go to the [Secrets page](https://github.com/onpaws/dbt-splitgraph-demo/settings/secrets/actions/new) for this
...
going to https://github.com/onpaws/dbt-splitgraph-demo/actions/workflows/build.yml and clicking "Run workflow". 
